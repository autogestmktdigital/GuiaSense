...
const DEFAULT_EXPENSE_CATEGORIES = [
  ...
  { name: "Lazer", icon: "gamepad", color: "#EC4899" },
  { name: "Assinaturas", icon: "repeat", color: "#14B8A6" },
  { name: "Compras", icon: "shopping-bag", color: "#F97316" },
  { name: "Financeiro", icon: "credit-card", color: "#6366F1" },
  { name: "Impostos e Taxas", icon: "file-text", color: "#64748B" },
  { name: "Família", icon: "users", color: "#F43F5E" },
  { name: "Cuidados Pessoais", icon: "scissors", color: "#D946EF" },
